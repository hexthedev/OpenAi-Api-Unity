...
namespace OpenAi.Api.V1
{
    ...
    /// </summary>
    public class ClassificationRequestV1 : AModelV1
    {
        /// <summary>
        ...
        /// <summary>
        /// [Required] Query to be classified.
        /// </summary>
        public string query;

        /// <summary>
        /// A list of examples with labels, in the follwing format: [["The movie is so interesting.", "Positive"], ["It is quite boring.", "Negative"], ...] All the label strings will be normalized to be capitalized. You should specify either examples or file, but not both.
        /// </summary>
        public LabeledExampleV1[] examples;
            ...
            foreach(JsonObject obj in json.NestedValues)
            {
                switch (obj.Name) 
                {
                    case nameof(model):
                        ...
                        break;
                    case nameof(query):
                        query = obj.StringValue;
                        break;
                    case nameof(examples):
                        examples = ArrayFromJson<LabeledExampleV1>(obj);
                        break;
                    case nameof(file):
                        file = obj.StringValue;
                        break;
                    case nameof(labels):
                        labels = obj.AsStringArray();
                        break;
                    ...
                    case nameof(logprobs):
                        ...
                        break;
                    case nameof(max_examples):
                        max_examples = int.Parse(obj.StringValue);
                        break;
